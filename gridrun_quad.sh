...
python3 t5_train.py --model-name unifiedqa-large-lr1 --datasets enhanced_synthetic_wiki_3 --epochs 4 --gpus 1 --save-model ./stored_models/unifiedqa-large_enhanced_synthetic_wiki_3.ckpt
