...
/usr/bin/python3 train.py --model_name unifiedqa-v2-large --datasets "synthetic_sciq_1" --epochs 8 --gpus 1 --save_best_model --exp_name unifiedqa-v2-large_s_sciq_1
/usr/bin/python3 train.py --model_name unifiedqa-v2-large --datasets "synthetic_sciq_2" --epochs 8 --gpus 1 --save_best_model --exp_name unifiedqa-v2-large_s_sciq_2
/usr/bin/python3 train.py --model_name unifiedqa-v2-large --datasets "synthetic_sciq_3" --epochs 8 --gpus 1 --save_best_model --exp_name unifiedqa-v2-large_s_sciq_3
