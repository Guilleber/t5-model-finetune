...
/usr/bin/python3 train.py --model_name unifiedqa-large-lr1 --datasets "75:commonsenseqa" --epochs 8 --gpus 1 --save_best_model --exp_name unifiedqa-large_csqa_75
/usr/bin/python3 train.py --model_name unifiedqa-large-lr1 --datasets "50:commonsenseqa" --epochs 8 --gpus 1 --save_best_model --exp_name unifiedqa-large_csqa_50
/usr/bin/python3 train.py --model_name unifiedqa-large-lr1 --datasets "25:commonsenseqa" --epochs 8 --gpus 1 --save_best_model --exp_name unifiedqa-large_csqa_25
