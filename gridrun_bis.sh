...
/usr/bin/python3 train.py --model_name unifiedqa-large-lr1 --datasets enhanced_synthetic_wiki_1 --epochs 4 --gpus 1 --save_best_model --exp_name unifiedqa-large_curriculum --load_model_from ./saved_models/unifiedqa-large_synthetic_wiki-v2.ckpt 
